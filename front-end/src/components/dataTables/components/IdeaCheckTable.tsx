...
import { ArrowForwardIcon, SunIcon, UnlockIcon } from '@chakra-ui/icons';
...
interface IdeaCheckTableType{
	...
	selectIdea: (idea: IdeaEntryType) => void
...
:<Flex align='center'>
			  ...
			  <Button onClick={()=>props.selectIdea(info.row.original)} ml="20px" ><ArrowForwardIcon /></Button>
