...
interface MarketGapTableType{
	tableData: TopMarketGapEntryType[];
}
...
export default function MarketGapTable(props: MarketGapTableType) {
	const columnHelper = createColumnHelper<TopMarketGapEntryType>();
	...
	const columns = [
		...
		columnHelper.accessor('Description', {
			...
			cell: (info: any) => (
					...
					info.row.original.MarketGapIdeaID == "" ? 
					<Flex>
...
:<Flex>
	{info.getValue() === 0 ? 
				<Text color="red" fontSize='sm' fontWeight='700' w='100%'>
					Negative
				</Text>:
				info.getValue() === 1 ? 
				<Text color={textColor} fontSize='sm' fontWeight='700' w='100%'>
				...
				<Text color="green" fontSize='sm' fontWeight='700' w='100%'>
				Positive
			</Text>
	}
		...
		,
		columnHelper.accessor('NicheScore', {
			id: 'NicheScore',
			header: () => (
...
:<Flex>
	...
	const widthColumns = ['15%', '55%', '15%', "15%"]
		...
		<Card borderRadius='7px' borderColor="black" bg={bgItem} px='24px' mt="40px" py='21px' >
            <Flex
                ...
                <Text color={textColor} fontSize='xl' fontWeight='600'>
                    Here's some market gaps generated by autonomous GPT...
                </Text>
            </Flex>
            </Card>
