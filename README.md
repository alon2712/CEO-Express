...
1. Brainstorming
   a. The user can input their own ideas of startups and all of this information will be displayed on the screen as well as 
      saved in the history for later uses.
2. Clicking Check Boxes
   a. The user can choose which ideas they want to generate more ideas on and will be able to see the display of the new ideas        that were generated.
3. Add Button
   a. Clicking on the add button will generate new ideas based on the current existing ones 
